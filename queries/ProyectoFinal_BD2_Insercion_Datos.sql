...
VALUES	('1203-12345-1245','Fedrah Zarra',1,'1995-09-16','Fedrah@correo.com','0912-9012','activo' ),
    ...
    ('1203-12345-1249','Héctor Inda',5,'1991-10-09','Héctor@correo.com','0912-9016','inactivo'),
    ...
    ('1203-12345-1259','Inés Teberga',15,'1989-03-17','Inés@correo.com','0912-9026','activo')
...
VALUES	('9856-88910-0101',30,'Arquimides','Zurica','1991-12-01','2017-10-09','2255-0910','Arquimides@correo.com','2021-12-01','Inactivo',1),
    ...
    ('9856-88910-0109',22,'José','Aliprando','1991-12-09','2019-06-21','2255-0918','José@correo.com','','Activo',4),
...
VALUES	(15,15,1,'2020-09-12','2020-10-09','850','Inactivo'),
    (14,14,2,'2020-09-12','2020-10-10','850','Inactivo'),
    (13,13,3,'2020-09-14','2020-10-11','850','Inactivo'),
    (12,8,4,'2020-09-15','2020-10-12','850','Inactivo'),
    (11,11,5,'2020-09-16','2020-10-13','850','Inactivo'),
    (10,2,6,'2020-09-17','2020-10-14','850','Inactivo'),
    (9,2,7,'2020-09-18','2020-10-15','850','Inactivo'),
    (8,3,8,'2020-09-19','2020-10-16','850','Inactivo'),
    (7,4,9,'2020-09-20','2020-10-17','850','Inactivo'),
    (6,4,10,'2020-09-21','2020-10-18','850','Inactivo'),
    (5,7,11,'2020-09-22','2020-10-19','850','Inactivo'),
    (4,7,12,'2020-09-23','2020-10-20','850','Inactivo'),
    (3,8,13,'2020-09-24','2020-10-21','850','Inactivo'),
    (2,2,14,'2020-09-25','2020-10-22','850','Inactivo'),
    (1,10,15,'2020-09-26','2020-10-23','850','Inactivo')

INSERT INTO clases(fecha,cliente,fecha_inicio,fecha_fin,contrato)
VALUES	('2020-09-16',15,'2020-09-14','2020-10-01',1),
    ('2020-09-17',14,'2020-09-15','2020-10-02',2),
    ('2020-09-18',13,'2020-09-16','2020-10-03',3),
    ('2020-09-19',12,'2020-09-17','2020-10-04',4),
    ('2020-09-20',11,'2020-09-18','2020-10-05',5),
    ('2020-09-21',10,'2020-09-19','2020-10-06',6),
    ('2020-09-22',9,'2020-09-20','2020-10-07',7),
    ('2020-09-23',8,'2020-09-21','2020-10-08',8),
    ('2020-09-24',7,'2020-09-22','2020-10-09',9),
    ('2020-09-25',6,'2020-09-23','2020-10-10',10),
    ('2020-09-26',5,'2020-09-24','2020-10-11',14),
    ('2020-09-27',4,'2020-09-25','2020-10-12',13),
    ('2020-09-28',3,'2020-09-26','2020-10-13',12),
    ('2020-09-29',2,'2020-09-27','2020-10-14',11),
    ('2020-09-30',1,'2020-09-28','2020-10-15',15)
